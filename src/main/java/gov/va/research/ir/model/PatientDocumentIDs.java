 ...
 * @author vhaislreddd
 */
public class PatientDocumentIDs {
	public final Integer patientId;
	public final Set<Integer> documentIdSet;
	public PatientDocumentIDs(final Integer patientId, final Set<Integer> documentIdSet) {
